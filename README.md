...
| Acceptance Criteria                                                                                                                  | Feature                                                | Action                                                                                                                                                                                              | Expected Result                                                                                        | Result |
| ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------ | ------ |
| The website should have a clear and prominently displayed "About Us" section accessible from the homepage.                           | Nav Bar - About Us link                                | Click on "ABOUT US" on nav, read more detail on About Us page                                                                                                                                       | Find information about the book club                                                                   | Pass   |
| Within this section, I should find a concise but informative summary of the club's mission, goals, and values.                       | About us text                                          | After clicking about us text, user should read more detail on 'About Us' page                                                                                                                       | Find information about the book club                                                                   | Pass   |
| I want to learn about the typical format of club meetings, including how often they occur and whether they are virtual or in-person. | Home Text, Book Clubs Text, Individual Book Club pages | User to read text on 'Home' page, 'Book Clubs' page for general information. User to click on 'Individul Book Club' pages ie 'Fiction' to find out information relating to the specific next event. | Find information about the book club and next event information including date and google map address. | Pass   |
| The website should outline any membership requirements or expectations, such as age restrictions, fees, or participation guidelines. | Home Text, Book Clubs Text and Join Us text            | User to read text on 'Home' page, 'Book Clubs' and 'Join Us' pages for general information on age restrictions and membership fees.                                                                 | Find information about the book club                                                                   | Pass   |
| I should be able to contact the club organizers or committee for additional inquiries or clarifications.                             | About us mailto: feature                               | User to click about us then 'click here to email' link                                                                                                                                              | Email pop up for the user to contact the book club comittee                                            | Pass   |
